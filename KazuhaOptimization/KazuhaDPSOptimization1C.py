...
def optimize (inputParameters, weaponName):
    ...
    EB = CharEB + WeapEB + 0.15 # accounting for anemo goblet, 2 pc VV effect
    ...
    def objective(x) :
        ...
        EM =  115.2 + 3*187 + e # iron sting 165 
        ...
        crit_Term = (1+(WeapCR+CharCR+0.033*r)*(WeapCD+CharCD+0.066*d))
